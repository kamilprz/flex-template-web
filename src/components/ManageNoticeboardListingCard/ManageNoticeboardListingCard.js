...
export const ManageNoticeboardListingCardComponent = props => {
  const {
    className,
    rootClassName,
    hasClosingError,
...
ManageNoticeboardListingCardComponent.defaultProps = {
  className: null,
  rootClassName: null,
...
ManageNoticeboardListingCardComponent.propTypes = {
  className: string,
...
export default compose(
  withRouter,
  injectIntl
)(ManageNoticeboardListingCardComponent);
