...
class EditNoticeboardListingWizard extends Component {
  constructor(props) {
    super(props);
  ...
  handlePayoutSubmit(values) {
    this.props
      ...
      .then(response => {
        this.props.onManageDisableScrolling('EditNoticeboardListingWizard.payoutModal', false);
      })
      .catch(() => {
        // do nothing
      });
  ...
  render() {
    ...
    if (!tabsStatus[selectedTab]) {
      ...
      return <NamedRedirect name="EditNoticeboardListingPage" params={{ ...params, tab: nearestActiveTab }} />;
    }
    ...
    const tabLink = tab => {
      return { name: 'EditNoticeboardListingPage', params: { ...params, tab } };
    };
    ...
    if (returnedNormallyFromStripe && stripeConnected && !requirementsMissing) {
      return <NamedRedirect name="EditNoticeboardListingPage" params={pathParams} />;
    }
    ...
    return (
      <div className={classes}>
        ...
        >
          {TABS.map(tab => {
            return (
              <EditNoticeboardListingWizardTab
                {...rest}
                key={tab}
                tabId={`${id}_${tab}`}
        ...
        <Modal
          id="EditNoticeboardListingWizard.payoutModal"
        ...
        >
          <div className={css.modalPayoutDetailsWrapper}>
            <h1 className={css.modalTitle}>
              <FormattedMessage id="EditNoticeboardListingPhotosPanel.payoutModalTitleOneMoreThing" />
              <br />
              <FormattedMessage id="EditNoticeboardListingPhotosPanel.payoutModalTitlePayoutPreferences" />
            </h1>
            <p className={css.modalMessage}>
              <FormattedMessage id="EditNoticeboardListingPhotosPanel.payoutModalInfo" />
            </p>
            {!currentUserLoaded ? (
...
EditNoticeboardListingWizard.defaultProps = {
  className: null,
  rootClassName: null,
  listing: null,
...
EditNoticeboardListingWizard.propTypes = {
