...
const EditNoticeboardListingDescriptionFormComponent = props => (
  <FinalForm
    {...props}
...
EditNoticeboardListingDescriptionFormComponent.defaultProps = { className: null, fetchErrors: null };

EditNoticeboardListingDescriptionFormComponent.propTypes = {
  className: string,
...
export default compose(injectIntl)(EditNoticeboardListingDescriptionFormComponent);
