...
import css from './EditNoticeboardListingPhotosForm.css';

const ACCEPT_IMAGES = 'image/*';

export class EditNoticeboardListingPhotosFormComponent extends Component {
  constructor(props) {
    super(props);
...
EditNoticeboardListingPhotosFormComponent.defaultProps = { fetchErrors: null, images: [] };

EditNoticeboardListingPhotosFormComponent.propTypes = {
  fetchErrors: shape({
...
export default compose(injectIntl)(EditNoticeboardListingPhotosFormComponent);
