...
import css from './EditNoticeboardListingPage.css';
...
export const EditNoticeboardListingPageComponent = props => {
  const {
    currentUser,
...
EditNoticeboardListingPageComponent.defaultProps = {
...
EditNoticeboardListingPageComponent.propTypes = {
...
const EditNoticeboardListingPage = compose(
  withRouter,
  connect(
    mapStateToProps,
    mapDispatchToProps
  )
)(injectIntl(EditNoticeboardListingPageComponent));

EditNoticeboardListingPage.loadData = loadData;

export default EditNoticeboardListingPage;
