  ...
  render() {
    ...
    const paginationLinks =
      listingsAreLoaded && pagination && pagination.totalPages > 1 ? (
        <PaginationLinks
          ...
          pageName="ManageNoticeboardListingsPage"
    ...
    return (
      <Page title={title} scrollingDisabled={scrollingDisabled}>
        <LayoutSingleColumn>
          <LayoutWrapperTopbar>
            <TopbarContainer currentPage="ManageNoticeboardListingsPage" />
            <UserNav selectedPageName="ManageNoticeboardListingsPage" />
          </LayoutWrapperTopbar>
          <LayoutWrapperMain>
...
ManageNoticeboardListingsPageComponent.defaultProps = {
  listings: [],
  pagination: null,
...
ManageNoticeboardListingsPageComponent.propTypes = {
...
const ManageNoticeboardListingsPage = compose(
  connect(
    mapStateToProps,
    mapDispatchToProps
  ),
  injectIntl
)(ManageNoticeboardListingsPageComponent);
...
export default ManageNoticeboardListingsPage;
