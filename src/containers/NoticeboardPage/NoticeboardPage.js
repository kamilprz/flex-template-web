...
import { SearchMap, ModalInMobile, Page, NamedLink} from '../../components';
...
const SEARCH_WITH_MAP_DEBOUNCE = 300; // Little bit of debounce before search is initiated.
  ...
  export class NoticeboardPageComponent extends Component {
    constructor(props) {
      super(props);
  ...
  NoticeboardPage.loadData = (params, search) => {
